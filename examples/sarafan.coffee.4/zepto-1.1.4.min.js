...
return $})()
window.Zepto=Zepto
window.$===undefined&&(window.$=Zepto);(function($){var data={},dataAttr=$.fn.data,camelize=$.camelCase,exp=$.expando='Zepto'+(+new Date()),emptyArray=[]
...
elements.removeData()
return origFn.call(this)}})})(Zepto);(function($){var $$=$.zepto.qsa,_zid=1,undefined,slice=Array.prototype.slice,isFunction=$.isFunction,isString=function(obj){return typeof obj=='string'},handlers={},specialEvents={},focus={focus:'focusin',blur:'focusout'},hover={mouseenter:'mouseover',mouseleave:'mouseout'}
...
function eventCapture(handler,captureSetting){return handler.del&&!!captureSetting}
function realEvent(type){return hover[type]||focus[type]||type}
...
return compatible(event)}})(Zepto);(function($){var zepto=$.zepto,oldQsa=zepto.qsa,oldMatches=zepto.matches
